...
export interface ApiAideAapQuestionsFrequenteAideAapQuestionsFrequente
  extends Struct.SingleTypeSchema {
  collectionName: 'aide_aap_questions_frequentes';
  info: {
    displayName: '[AIDE-AAP] - Questions fr\u00E9quentes';
    pluralName: 'aide-aap-questions-frequentes';
    singularName: 'aide-aap-questions-frequente';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::aide-aap-questions-frequente.aide-aap-questions-frequente'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAideCandidatQuestionsFrequenteAideCandidatQuestionsFrequente
  extends Struct.SingleTypeSchema {
  collectionName: 'aide_candidat_questions_frequentes';
  info: {
    displayName: '[AIDE-CANDIDAT] - Questions fr\u00E9quentes';
    pluralName: 'aide-candidat-questions-frequentes';
    singularName: 'aide-candidat-questions-frequente';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::aide-candidat-questions-frequente.aide-candidat-questions-frequente'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAideCandidatRessourcesUtileAideCandidatRessourcesUtile
  extends Struct.SingleTypeSchema {
  collectionName: 'aide_candidat_ressources_utiles';
  info: {
    displayName: '[AIDE-CANDIDAT] - Ressources utiles';
    pluralName: 'aide-candidat-ressources-utiles';
    singularName: 'aide-candidat-ressources-utile';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::aide-candidat-ressources-utile.aide-candidat-ressources-utile'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiArticleDAideArticleDAide
  ...
  attributes: {
    ...
    ordre: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    section_d_aides: Schema.Attribute.Relation<
      'manyToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vignette: Schema.Attribute.Media<'images' | 'videos'> &
      Schema.Attribute.Required;
  };
}

export interface ApiArticleFaqArticleFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reponse: Schema.Attribute.RichText &
      ...
      >;
    sous_section_faq: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiArticleRegionArticleRegion
  extends Struct.CollectionTypeSchema {
...
export interface ApiDepartementDepartement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    prcs: Schema.Attribute.Relation<'oneToMany', 'api::prc.prc'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLegalLegal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateDeMiseAJour: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::legal.legal'> &
      Schema.Attribute.Private;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    nouvelleVersion: Schema.Attribute.Boolean & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPrcPrc extends Struct.CollectionTypeSchema {
  collectionName: 'prcs';
  info: {
    description: '';
    displayName: 'PRC';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departement: Schema.Attribute.Relation<
      'manyToOne',
      'api::departement.departement'
    >;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::prc.prc'> &
      Schema.Attribute.Private;
    mandataire: Schema.Attribute.String;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRegionRegion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_regions: Schema.Attribute.Relation<
      'manyToMany',
      'api::article-region.article-region'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departements: Schema.Attribute.Relation<
      'oneToMany',
      'api::departement.departement'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlExternePRCs: Schema.Attribute.String;
    vignette: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
  };
}

export interface ApiSectionDAideSectionDAide
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_d_aides: Schema.Attribute.Relation<
      'manyToMany',
      'api::article-d-aide.article-d-aide'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSectionFaqSectionFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    ordre: Schema.Attribute.Integer;
    pictogramme: Schema.Attribute.Enumeration<
      [
        'airport',
        'application',
        'avatar',
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sous_section_faqs: Schema.Attribute.Relation<
      'oneToMany',
      'api::sous-section-faq.sous-section-faq'
    >;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSousSectionFaqSousSectionFaq
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_faqs: Schema.Attribute.Relation<
      'oneToMany',
      'api::article-faq.article-faq'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    ordre: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    section_faq: Schema.Attribute.Relation<
      'manyToOne',
      'api::section-faq.section-faq'
    >;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aide-aap-questions-frequente.aide-aap-questions-frequente': ApiAideAapQuestionsFrequenteAideAapQuestionsFrequente;
