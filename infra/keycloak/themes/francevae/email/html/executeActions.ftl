...
<@layout.emailLayout ; section>
    <#if section = "title">
      Invitation à rejoindre Reva
    <#elseif section = "intro">
      Vous avez créé un compte ou vous avez été invité à rejoindre Reva. Pour poursuivre la création de votre compte nous vous invitons à cliquer sur le boutons ci-dessous. Il vous sera alors demandé de créer un mot de passe.
