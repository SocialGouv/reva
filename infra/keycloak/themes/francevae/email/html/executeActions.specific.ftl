...
<@layout.emailLayout ; section>
    ...
    <#elseif section = "actionButton">
      <a href="${link}" style="display:inline-block;background:#00007f;color:white;font-family:Arial, sans-serif;font-size:18px;font-weight:500;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:15px 24px;mso-padding-alt:0px;" target="_blank"><span style="font-size:14px;">Mettre à jour mon mot de passe</span></a>
