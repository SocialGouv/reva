            ...
            >
              <ul class="flex flex-col list-none px-0 py-2 lg:py-0 m-0 lg:flex-row lg:text-sm lg:font-normal">
                <li class="py-2 border-0 border-b lg:border-b-0 border-solid border-slate-200 lg:p-4 lg:pb-0">
                  <a class="flex flex-row items-center no-underline pl-4 lg:pl-0 lg:pb-4 text-black" href="${properties.revaUrl}">
        ...
        <div class="fr-container">
          ...
          <div class="fr-footer__bottom">
            <ul class="fr-footer__bottom-list">
              ...
              <li class="fr-footer__bottom-item">
                <a class="fr-footer__bottom-link" href="https://vae.gouv.fr/mentions-legales">Mentions légales</a>
              </li>
              <li class="fr-footer__bottom-item">
