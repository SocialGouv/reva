...
<@layout.registrationLayout displayMessage=false; section>
    ...
    <div id="kc-info-message">
        ...
        <#if pageRedirectUri?has_content>
            <a  class="button" href="${pageRedirectUri}">Poursuivre sur Reva</a>
        <#elseif actionUri?has_content>
            <a class="button" href="${actionUri}">Poursuivre sur Reva</a>
        <#elseif (client.baseUrl)?has_content>
            <a href="${client.baseUrl}">Poursuivre sur Reva</a>
        <#else>
            <a class="button" href="${properties.revaUrl}">Poursuivre sur Reva</a>
        </#if>
    </div>
    </#if>
