...
<html itemscope itemtype="http://schema.org/WebPage" lang="fr">
  <head>
    ...
    <meta name="description" content="Connexion candidat France VAE" />

    <title>France VAE | Connexion</title>
    ...
    <#-- C22: Redirect ALL broker/IDP errors to candidate app auth-error page -->
    <#if message?has_content && message.type == 'error'>
      <#-- Map Keycloak error messages to OAuth error codes -->
      <#if message.summary?lower_case?contains("denied") || message.summary?lower_case?contains("access")>
        <#assign errorCode = "access_denied">
      <#elseif message.summary?lower_case?contains("invalid") || message.summary?lower_case?contains("expired")>
        <#assign errorCode = "invalid_request">
      <#else>
        <#assign errorCode = "server_error">
      </#if>
      <script>
        window.location.replace("${properties.candidateBaseUrl}/auth-error?error=${errorCode}");
      </script>
    </#if>
  </head>
                ...
                <div class="fr-header__brand-top">
                  <div class="fr-header__logo">
                    <a title="Accueil - France VAE" href="/">
                      <p class="fr-logo">R&eacute;publique<br> Fran&ccedil;aise</p>
                    </a>
                  </div>
                  <div class="fr-header__operator">
                    <a title="Accueil - France VAE" href="${properties.candidateBaseUrl}">
          ...
          <div class="fr-footer__body">
            ...
            <div class="fr-footer__content">
              <p class="fr-footer__content-desc">
                France VAE est le portail officiel du service public qui vise &agrave;
          ...
          <div class="fr-footer__bottom">
            <ul class="fr-footer__bottom-list">
              <li class="fr-footer__bottom-item">
                <a class="fr-footer__bottom-link" href="https://vae.gouv.fr/declaration-accessibilite">Accessibilit&eacute; : partiellement conforme</a>
              </li>
              <li class="fr-footer__bottom-item">
              ...
              <li class="fr-footer__bottom-item">
                <a class="fr-footer__bottom-link" href="https://vae.gouv.fr/mentions-legales">Mentions l&eacute;gales</a>
              </li>
              <li class="fr-footer__bottom-item">
                <a class="fr-footer__bottom-link" href="https://vae.gouv.fr/politique-de-confidentialite">Donn&eacute;es personnelles</a>
              </li>
              <li class="fr-footer__bottom-item">
