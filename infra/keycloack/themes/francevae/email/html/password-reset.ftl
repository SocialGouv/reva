...
<@layout.emailLayout ; section>
    <#if section = "title">
      Reva - Récupération de mot de passe
    <#elseif section = "intro">
      Nous avons reçu une demande de récupération de mot de passe pour le site Reva pour cette adresse électronique. Si vous avez bien effectué cette demande, vous pouvez changer de mot de passe en cliquant sur le lien ci-dessous:
