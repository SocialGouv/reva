...
<@layout.emailLayout ; section>
    <#if section = "title">
      Reva - Invitation à changer de mot de passe
    <#elseif section = "intro">
      Dans une démarche de renforcement de la sécurité de Reva, nous vous prions de bien vouloir choisir un nouveau mot de passe. Pour cela, cliquez sur le lien ci-dessous:
