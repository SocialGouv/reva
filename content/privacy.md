# Politique de confidentialité de REVA
...
À des fins de compréhension et d'analyse des usages du site par les utilisateurs, nous utilisons les outils de traçage suivant :
...
* **Hotjar**, un outil de mesure et d'analyse des comportements des utilisateurs sur le site. Certaines informations, comme votre adresse IP, peuvent temporairement être utilisées par l'outil afin de fournir le service associé. Toutefois, l'outil est paramétré pour être en conformité avec la réglementation et éviter l'enregistrement des données personnelles qui pourraient s'afficher sur les écrans visités.
