...
const description = `<p>${loremIpsum}</p> <h2>Activité</h2><p>${loremIpsum}</p> <h2>Compétence</h2><p>${loremIpsum}</p> <h2>Secteurs d'activités</h2><p>${loremIpsum}</p> <h2>Types d'emplois accessibles</h2><p>${loremIpsum}</p>`;
