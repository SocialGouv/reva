            ...
            <Alert
              ...
              title={
                <div className="flex flex-col items-start gap-2 font-normal">
                  <h2 className="font-bold text-xl">Maintenance en cours</h2>
                  <p>
                    En raison d'une maintenance en cours sur notre site, le
                    dépôt de nouvelles candidatures est temporairement
