...
type alias AccountCreateAccountOptionalArguments = { account : OptionalArgument Admin.InputObject.AccountInput }

account_createAccount : (AccountCreateAccountOptionalArguments -> AccountCreateAccountOptionalArguments)
...
type alias CandidacyCreateCandidacyRequiredArguments = { candidacy : Admin.InputObject.CandidacyInput }

candidacy_createCandidacy : CandidacyCreateCandidacyRequiredArguments
...
type alias CandidacySubmitCandidacyRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id }

candidacy_submitCandidacy : CandidacySubmitCandidacyRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet (Maybe decodesTo) RootMutation
...
type alias CandidacyUpdateCertificationRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id
 , certificationId : Data.Scalar.Id
 , departmentId : Data.Scalar.Id }

candidacy_updateCertification : CandidacyUpdateCertificationRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet (Maybe decodesTo) RootMutation
...
type alias CandidacyAddExperienceOptionalArguments = { experience : OptionalArgument Admin.InputObject.ExperienceInput }

type alias CandidacyAddExperienceRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id }

candidacy_addExperience : (CandidacyAddExperienceOptionalArguments -> CandidacyAddExperienceOptionalArguments)
...
type alias CandidacyUpdateExperienceOptionalArguments = { experience : OptionalArgument Admin.InputObject.ExperienceInput }

type alias CandidacyUpdateExperienceRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id
 , experienceId : Data.Scalar.Id }

candidacy_updateExperience : (CandidacyUpdateExperienceOptionalArguments -> CandidacyUpdateExperienceOptionalArguments)
...
type alias CandidacyRemoveExperienceRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id
 , experienceId : Data.Scalar.Id }

candidacy_removeExperience : CandidacyRemoveExperienceRequiredArguments
...
type alias CandidacyUpdateGoalsRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id
 , goals : (List Admin.InputObject.CandidateGoalInput) }

candidacy_updateGoals : CandidacyUpdateGoalsRequiredArguments
...
type alias CandidacyUpdateContactOptionalArguments = { email : OptionalArgument String
 , phone : OptionalArgument String }

type alias CandidacyUpdateContactRequiredArguments = { deviceId : Data.Scalar.Id
 , candidacyId : Data.Scalar.Id }

candidacy_updateContact : (CandidacyUpdateContactOptionalArguments -> CandidacyUpdateContactOptionalArguments)
...
type alias CandidacyArchiveByIdRequiredArguments = { candidacyId : Data.Scalar.Id }

candidacy_archiveById : CandidacyArchiveByIdRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacyDeleteByIdRequiredArguments = { candidacyId : Data.Scalar.Id }

candidacy_deleteById : CandidacyDeleteByIdRequiredArguments
...
type alias CandidacyUpdateAppointmentInformationsRequiredArguments = { candidacyId : Data.Scalar.Id
...
candidacy_updateAppointmentInformations : CandidacyUpdateAppointmentInformationsRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacyTakeOverRequiredArguments = { candidacyId : Data.Scalar.Id }

candidacy_takeOver : CandidacyTakeOverRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacySelectOrganismRequiredArguments = { candidacyId : Data.Scalar.Uuid
 , organismId : Data.Scalar.Uuid }

candidacy_selectOrganism : CandidacySelectOrganismRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacySubmitTrainingFormRequiredArguments = { candidacyId : Data.Scalar.Uuid
 , training : Admin.InputObject.TrainingInput }

candidacy_submitTrainingForm : CandidacySubmitTrainingFormRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacyConfirmTrainingFormRequiredArguments = { candidacyId : Data.Scalar.Uuid }

candidacy_confirmTrainingForm : CandidacyConfirmTrainingFormRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidacyDropOutRequiredArguments = { candidacyId : Data.Scalar.Uuid
 , dropOut : Admin.InputObject.DropOutInput }

candidacy_dropOut : CandidacyDropOutRequiredArguments
 -> SelectionSet decodesTo Admin.Object.Candidacy
 -> SelectionSet decodesTo RootMutation
...
type alias CandidateAskForRegistrationRequiredArguments = { candidate : Admin.InputObject.CandidateInput }

candidate_askForRegistration : CandidateAskForRegistrationRequiredArguments
 -> SelectionSet String RootMutation
...
type alias CandidateAskForLoginRequiredArguments = { email : String }

candidate_askForLogin : CandidateAskForLoginRequiredArguments
 -> SelectionSet String RootMutation
...
type alias CandidateLoginRequiredArguments = { token : String }

candidate_login : CandidateLoginRequiredArguments
...
type alias CandidateCreateFundingRequestRequiredArguments = { candidacyId : Data.Scalar.Uuid
 , fundingRequest : Admin.InputObject.FundingRequestInput }

candidate_createFundingRequest : CandidateCreateFundingRequestRequiredArguments
...
type alias CandidateUpdateCandidateRequiredArguments = { id : Data.Scalar.Uuid
 , candidate : Admin.InputObject.FullCandidateInput }

candidate_updateCandidate : CandidateUpdateCandidateRequiredArguments
