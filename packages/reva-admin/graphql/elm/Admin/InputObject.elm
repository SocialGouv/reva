...
buildAccountInput : AccountInputRequiredFields
...
buildAppointmentInformationsInput : AppointmentInformationsInputRequiredFields
...
buildCandidacyInput : CandidacyInputRequiredFields
 -> CandidacyInput
...
buildCandidateGoalInput : CandidateGoalInputRequiredFields
...
buildCandidateInput : CandidateInputRequiredFields
 -> CandidateInput
...
buildCandidateTypologyInformationsInput : CandidateTypologyInformationsInputRequiredFields
...
buildCertificationChangeInput : CertificationChangeInputRequiredFields
...
buildDropOutInput : DropOutInputRequiredFields
...
buildDropOutInput required____ fillOptionals____ =
    ...
    in
    { droppedOutAt = required____.droppedOutAt, dropOutReasonId = required____.dropOutReasonId, otherReasonContent = optionals____.otherReasonContent, dropOutDate = required____.dropOutDate }
...
encodeDropOutInput input____ =
    Encode.maybeObject
        [ ( "droppedOutAt", ((Data.Scalar.codecs |> Admin.Scalar.unwrapEncoder .codecTimestamp))  input____.droppedOutAt |> Just ), ( "dropOutReasonId", ((Data.Scalar.codecs |> Admin.Scalar.unwrapEncoder .codecUuid))  input____.dropOutReasonId |> Just ), ( "otherReasonContent", (Encode.string)  |> Encode.optional input____.otherReasonContent ), ( "dropOutDate", ((Data.Scalar.codecs |> Admin.Scalar.unwrapEncoder .codecTimestamp))  input____.dropOutDate |> Just ) ]


buildExperienceInput : ExperienceInputRequiredFields
 -> ExperienceInput
...
buildFullCandidateInput : (FullCandidateInputOptionalFields -> FullCandidateInputOptionalFields)
 -> FullCandidateInput
...
buildFundingRequestInput : FundingRequestInputRequiredFields
 -> FundingRequestInput
...
buildTrainingInput : TrainingInputRequiredFields
 -> TrainingInput
