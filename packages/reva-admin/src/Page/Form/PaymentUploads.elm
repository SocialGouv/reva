...
form _ ( _, _ ) =
    { elements =
        [ ( "files-heading", Form.Title1 "1 - Pièces justificatives à joindre" )
        , ( "invoice-files-help"
        ...
        , ( "other-help-heading", Form.Title2 "Documents" )
        ...
        , ( "other-help-heading", Form.Title1 "2 - Pièces justificatives à conserver" )
        , ( "other-help"
