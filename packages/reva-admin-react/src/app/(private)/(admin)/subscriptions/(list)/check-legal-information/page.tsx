...
import { SubscriptionRequestCard } from "@/app/(private)/(admin)/subscriptions/components/subscription-request-card/SubscriptionRequestCard";
...
const getLegalVerificationPendingSubscriptionRequests = graphql(`
  query getLegalVerificationPendingMaisonMereAAPs(
    $offset: Int
    $searchFilter: String
  ) {
