...
import { useDossierDeValidationProblemPageLogic } from "@/app/(private)/(certificateur)/candidacies/[candidacyId]/dossier-de-validation/problem/dossierDeValidationProblemPageLogic";
