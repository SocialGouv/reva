...
export default function EligibilityPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <p>
          Sélectionnez <strong>"Demande initiale de recevabilité"</strong> si la
          recevabilité n’a pas été obtenue pour la certification visée.
          <br />
          Exemple : C'est la première fois qu’une candidature est présentée pour
          faire une VAE sur cette certification.
        </p>

        <p>
          Sélectionner <strong>"Demande de renouvellement"</strong> seulement si
          une recevabilité a déjà été obtenue sur l'ancienne version de la
        ...
        <p>
          ...
          peut prendre plusieurs mois). Si vous n'êtes pas sûr que le dossier de
          validation soit fini d'ici à cette date, contactez le certificateur.
        </p>
