...
const replacementModal = createModal({
...
export default function ReplaceCertificationPage() {
  ...
  if (getCertificationQueryStatus !== "success" || !certification) {
    return <>{getCertificationQueryStatus}</>;
  }
  ...
  return (
    <div data-test="replace-certification-page">
      ...
      <p className="mb-12 text-xl">
        ...
        Compétences et du Formacode. Si vous rencontrez des difficultés pour
        remplacer une certification, contactez l'équipe support France VAE à
        contact@vae.gouv.fr
      </p>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            contactez contact@vae.gouv.fr
          </p>
          <p>Voulez-vous confirmer le remplacement de cette certification ?</p>
        </div>
      </replacementModal.Component>
    </div>
  );
