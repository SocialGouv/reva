...
const StatusTag = ({
  ...
  switch (true) {
    ...
    case status === "PARCOURS_CONFIRME":
      return <Tag small>Parcours validé par le candidat</Tag>;
    ...
    case isSentToCandidate &&
      ...
      !hasSwornStatement &&
      feasibility.decision === "DRAFT":
      return <Tag small>Dossier de faisabilité validé partiellement</Tag>;
    case isSentToCandidate &&
      hasCandidateConfirmed &&
      hasSwornStatement &&
      feasibility.decision === "DRAFT":
      return <Tag small>Dossier de faisabilité validé totalement</Tag>;
