  ...
  <label key={props.certification.id} className="relative flex items-center bg-white p-4 shadow-sm focus:outline-none">
    <span className="flex flex-1">
      <span className="pr-2">
        ...
        <span className="block text-sm font-ligth text-gray-700 mt-2">Vous avez {props.certification.nb_activities_match} compétence(s) sur les {props.certification.nb_activities_total} associée(s) à cette certification.</span>
      </span>
    </span>
