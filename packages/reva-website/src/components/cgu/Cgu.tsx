export const Cgu = () => (
  <div>
    ...
    <p>
      Chaque Structure professionnelle dispose d’un compte et d’un parcours
      personnalisé lui permettant de suivre les candidatures des candidats (sur
      la base de la certification choisie et du secteur géographique de ce
      dernier).
    </p>
    ...
    <p>
      La Structure Professionnelle renseigne notamment, en s’inscrivant, la date
      de validation de sa certification Qualiopi, des données de contact (nom,
      prénom et adresse e-mail). Elle sélectionne également sa typologie
      ...
      collective) en fonction de ce critère. La Structure Professionnelle doit
      également choisir une zone d’intervention basée sur le département ou le
      distanciel.
    </p>
    <p>
    ...
    <p>
      La Structure Professionnelle en qualité d’architecte de parcours bénéficie
      de documents avec accès restreint via l’espace PRO.
    </p>
    ...
    <p>
      La structure professionnelle s'assure de garder son mot de passe secret.
      Toute divulgation du mot de passe, quelle que soit sa forme, est
    ...
    <br />
    <p>Dernière version des CGU : 14/03/2023</p>
  </div>
);
