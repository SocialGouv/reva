export const Cgu = () => (
  <div>
    ...
    <p>
      <u>Certification professionnelle :</u> La loi n°2018-71 du 5 septembre
      2018 définit la certification professionnelle comme étant un diplôme, un
      titre professionnel ou à finalité professionnelle, un certificat de
      qualification professionnelle (CQP), des blocs de compétences ou bien
      encore des certifications ou habilitations enregistrés au répertoire
      national des certifications professionnelles (RNCP) ou au répertoire
      spécifique (RS). Une certification professionnelle est délivrée par une
      autorité compétente après vérification des compétences ou connaissances
      d'une personne.
    </p>
    <p>
    ...
    <p>
      À ce titre, il est habilité à prononcer la recevabilité de la demande de
      VAE et à valider tout ou partie de la certification visée. Il a également
      la responsabilité des modalités de mise en œuvre de la VAE pour ses
    ...
    <p>
      <u>Visiteur :</u> Personne qui consulte la plateforme France VAE pour y
    ...
    <p>
      <u>Réorientation :</u> Décision de ne pas poursuivre sa démarche, avant le
    ...
    <p>
      ...
      déposé leur dossier de validation, ainsi que ceux des personnes se
      présentant devant un jury jusqu'à l'obtention de leur résultat et, le cas
      échéant, l'entretien post jury.
    </p>
    <p>
    ...
    <p>
      <u>Dossier de faisabilité :</u> Le dossier de faisabilité permet au
      certificateur de vérifier que le projet de VAE d'un candidat correspond
    ...
    <p>
      ...
      relatif à la réalisation du parcours de la part du candidat.{" "}
    </p>
    <p>
      <u>Retrait/rétractation : </u>La décision prise par un candidat ou le
    ...
    <p>
      <u>Entretien post-jury :</u> Il s'agit d'un entretien entre un candidat et
    ...
    <ol>
      <li>
        <strong>Fonctionnalités de la plateforme</strong>
      </li>
    </ol>
    <p>
    ...
    <p>
      ...
      utilisateur, France VAE pourra être amené à effectuer des vérifications
      d'identité et, le cas échéant, à demander des justificatifs afin d'assurer
    ...
    <p>
      <strong>Architecte Accompagnateur de Parcours :</strong>
    </p>
    <p>
    ...
    <ol>
      <li>
        <strong>Règles relatives à la modération sur la plateforme</strong>
      </li>
    </ol>
    <p>
    ...
    <ol>
      <li>
        <strong>Engagements du candidat</strong>
      </li>
    </ol>
    <p>
      <strong>5.1 Règles générales</strong>
    </p>
    <p>
    ...
    <p>
      <strong>5.2 Cas de l’abandon du parcours</strong>
    </p>
    <p>
    ...
    <p>
      <strong>5.3 Procédure de certification </strong>
    </p>
    <p>
    ...
    <p>
      <strong>5.4 Suspension du compte candidat</strong>
    </p>
    <p>
    ...
    <p>
      <strong>5.5 Désactivation du compte</strong>
    </p>
    <p>
    ...
    <ol>
      <li>
        <strong>Engagements de l’organisme AAP</strong>
      </li>
    </ol>
    <p>
      <strong>6.1 Règles générales et obligations des organismes</strong>
    </p>
    <p>
    ...
    <p>
      <strong>6.2 Règles relatives aux déréférencements</strong>
    </p>
    <p>
    ...
    <ol>
      <li>
        <strong>Engagements des titulaires de compte AAP</strong>
      </li>
    </ol>
    <p>
      <strong>7.1 Règles générales et obligations</strong>
    </p>
    <p>
    ...
    <p>
      <strong>7.2 Confidentialité des données</strong>
    </p>
    <p>
    ...
    <p>
      <strong>7.3 Réutilisation des données</strong>
    </p>
    <p>
    ...
    <ol>
      <li>
        <strong>Contrôles et vérifications par France VAE</strong>
      </li>
    </ol>
    <p>
    ...
    <ol>
      <li>
        <strong>Sécurité des comptes et exports de données</strong>
      </li>
    </ol>
    <p>
    ...
    <ol>
      <li>
        <strong>Mise à jour des CGU</strong>
      </li>
    </ol>
    <p>
