...
export const Financement = () => (
  <section
    id="financement"
    className="w-full lg:bg-[url('/candidate-space/home-page/section-background/polygons-section6.svg')] lg:bg-cover bg-no-repeat"
  >
    <div className="fr-container max-w-[1248px] mx-auto mt-20 lg:my-[400px] overflow-x-hidden flex flex-col gap-x-24 lg:flex-row lg:items-center">
      <div className="px-5">
        <header>
          <SectionHeader>
