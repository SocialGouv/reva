    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-6 pt-8 w-full items-center lg:items-start">
        <AapStepBlock
          ...
          imageUrl="/candidate-space/aap-step-characters/aap-step-character-diagnostic.png"
        ...
        <AapStepBlock
          ...
          imageUrl="/candidate-space/aap-step-characters/aap-step-character-conception.png"
        ...
        <AapStepBlock
          ...
          imageUrl="/candidate-space/aap-step-characters/aap-step-character-accompagnement.png"
          imageAlt="Deux personnes qui discutent"
        />
      </div>
      <div className="flex flex-col lg:flex-row items-center relative lg:ml-10 text-start  border-b-[4px] border-b-[#FFA180] shadow-[0px_6px_18px_0px_rgba(0,0,18,0.16)] py-8 px-8 w-full mt-14 lg:mt-0 lg:h-[132px]">
        <Image
          src="/candidate-space/image-home-character-young-man-glasses.png"
          width={181}
          height={211}
