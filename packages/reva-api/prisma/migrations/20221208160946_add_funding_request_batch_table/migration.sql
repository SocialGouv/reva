...
-- AddForeignKey
ALTER TABLE "funding_request_batch"
ADD CONSTRAINT "funding_request_batch_funding_request_id_fkey" FOREIGN KEY ("funding_request_id") REFERENCES "funding_request"("id") ON DELETE RESTRICT ON UPDATE CASCADE;