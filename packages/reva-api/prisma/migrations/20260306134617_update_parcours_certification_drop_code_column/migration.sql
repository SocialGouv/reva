/*
  ...
  - You are about to drop the column `code` on the `parcours_certification` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "parcours_certification_code_key";

-- AlterTable
ALTER TABLE "parcours_certification" DROP COLUMN "code";
