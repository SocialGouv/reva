...
export const getDepartments = (deps: GetDepartmentsDeps) => async () => 
    EitherAsync.fromPromise(() => deps.getDepartments())
        .mapLeft(() => new FunctionalError(FunctionalCodeError.TECHNICAL_ERROR, 'Erreur lors de la récupération des départements'));
