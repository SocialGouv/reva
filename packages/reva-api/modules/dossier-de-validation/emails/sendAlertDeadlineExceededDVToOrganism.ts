...
export const sendAlertDeadlineExceededDVToOrganism = ({
  ...
  const htmlContent = (url: string) =>
    mjml2html(
      templateMail({
        content: `
          <p>Bonjour,</p>
          <p>France VAE vous informe que vous avez dépassé le délai de renseignement de date prévisionnelle à laquelle l'un de vos candidats aura finalisé son dossier de validation.</p>
  ...
  return sendEmailWithLink({
    ...
    subject: "Dépassement du délai de saisie de la date prévisionnelle",
  });
};
