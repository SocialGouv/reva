...
/**
 * Test assignCandidaciesToCreatedCertificationAuthorityLocalAccount
 */
test("should return candidacies to created certification authority local accounts based on same certification and department", async () => {
