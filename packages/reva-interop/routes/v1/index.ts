...
<html>
  ...
  <body>
    <redoc spec-url='${process.env.BASE_URL || "http://localhost"}:${process.env.PORT || 8080}/v1/documentation/json' schema-expansion-level="1" json-sample-expand-level="3" hide-schema-titles></redoc>
